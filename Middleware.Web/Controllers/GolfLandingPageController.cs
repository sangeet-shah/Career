...
using Middleware.Web.Models.GolfLanding;
...
public class GolfLandingPageController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> Register([FromBody] GolfLandingPageModel model)
    {
        ...
        if (ModelState.IsValid)
        {
            ...
            if (picture != null)
            {
                ...
                var imageUrl = $"{Request.Scheme}://{Request.Host.Value}/images/golf-regisration/{fileName}";
